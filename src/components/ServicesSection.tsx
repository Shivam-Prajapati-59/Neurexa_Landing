    ...
    <div className="bg-white min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8 xl:px-20">
      <div className="max-w-8xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-16 xl:gap-20 items-end ">
          ...
          <div className="lg:col-span-5 xl:col-span-4 order-2 lg:order-1 pb-18">
          ...
          <div className="lg:col-span-7 xl:col-span-8 order-1 lg:order-2 flex items-center justify-center lg:justify-end pb-20">
